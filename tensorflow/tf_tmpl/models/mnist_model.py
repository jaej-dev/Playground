...
class MnistModel(BaseModel):
    ...
    def build_model(self):
        ...
        with tf.variable_scope('network'):
            conv1 = MnistModel.conv_bn_relu('conv1', self.x_img, out_filters=16,
                    kernel_size=[3,3], training_flag=self.is_training)
            conv2 = MnistModel.conv_bn_relu('conv2', conv1, out_filters=32,
                    kernel_size=[3,3], training_flag=self.is_training)
            ...
            conv3 = MnistModel.conv_bn_relu('conv3', pool1, out_filters=64,
                    kernel_size=[3,3], training_flag=self.is_training)
            conv4 = MnistModel.conv_bn_relu('conv4', conv3, out_filters=128,
                    kernel_size=[3,3], training_flag=self.is_training)
            ...
            dense1 = MnistModel.dense_bn_relu_dropout('dense1', flattened,
                     num_neurons=512, dropout_rate=0.5,
                     training_flag=self.is_training)
            dense2 = MnistModel.dense_bn_relu_dropout('dense2', dense1,
