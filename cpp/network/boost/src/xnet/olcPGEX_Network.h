...
template <typename T> 
struct message {
  message_header<T> header{}; // T will be enum class
  ...
  friend message<T> &operator<<(message<T> &msg, const DataType &data) {
    ...
    msg.body.resize(msg.body.size() + sizeof(DataType)); // just like stack
...
// to store which client is connected to server
template <typename T> 
